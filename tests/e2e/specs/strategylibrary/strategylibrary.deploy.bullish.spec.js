/**
 * Strategy Library Deployment Tests - Bullish Strategies
 *
 * Tests deployment of all bullish strategies from Strategy Library to Strategy Builder:
 * - Bull Call Spread (2 legs)
 * - Bull Put Spread (2 legs)
 * - Synthetic Long (2 legs)
 *
...
const BULLISH_STRATEGIES = [
  'bull_call_spread',
  'bull_put_spread',
  'synthetic_long'
];

test.describe('Strategy Library Deploy - Bullish Strategies @deploy @bullish', () => {
  ...
  // Generate tests for each bullish strategy
  for (const strategyName of BULLISH_STRATEGIES) {
