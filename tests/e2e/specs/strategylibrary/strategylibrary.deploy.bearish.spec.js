/**
 * Strategy Library Deployment Tests - Bearish Strategies
 *
 * Tests deployment of all bearish strategies from Strategy Library to Strategy Builder:
 * - Bear Put Spread (2 legs)
 * - Bear Call Spread (2 legs)
 * - Synthetic Short (2 legs)
 *
...
const BEARISH_STRATEGIES = [
  'bear_put_spread',
  'bear_call_spread',
  'synthetic_short'
];

test.describe('Strategy Library Deploy - Bearish Strategies @deploy @bearish', () => {
  ...
  // Generate tests for each bearish strategy
  for (const strategyName of BEARISH_STRATEGIES) {
